...
{
	float dragForce = 0.5f * _generalCoefficient * _objectDensity * _objectArea * _velocity.Magnitude() * _velocity.Magnitude();
...
{
	float frictionForceMagnitude = _generalCoefficient * _mass;
