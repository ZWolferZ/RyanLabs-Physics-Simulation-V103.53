...
public:
	/// <summary>
	/// Creates the AABB from the transform of the object as the center and the minimum and maximum points specified.
	/// </summary>
...
#pragma  region GettersandSetters
	...
	/// <summary>
	/// Return the minimum points of the AABB.
	/// </summary>
	...
	/// </summary>
	/// <returns> of the name of the collider.</returns>
